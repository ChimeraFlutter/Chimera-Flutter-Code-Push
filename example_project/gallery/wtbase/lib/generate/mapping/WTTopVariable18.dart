...
class WTTopVariable18 extends WTVMBaseType<dynamic> {
  static WTTopVariable18? _instance;
  factory WTTopVariable18() => _instance ??= WTTopVariable18._internal();

  WTTopVariable18._internal() {
    definePath =
